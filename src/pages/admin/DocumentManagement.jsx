...
const DocumentManagement = () => {
  ...
  const handleAddDocument = async (e) => {
    ...
    try {
      ...
      const category = categories.find(cat => cat.id === documentData.categoryId);
      ...
      setTimeout(() => {
        setNewDocument({ title: '', categoryId: '' });
  ...
  const handleUpdateDocument = async (e) => {
    ...
    try {
      ...
      const updatedDocument = await updateDocument(editDocument.id, documentData);
      ...
      setFormError('Đã xảy ra lỗi khi cập nhật tài liệu. Vui lòng thử lại sau.');
    } finally {
      setIsSubmitting(false);
    }
  };
  ...
  const handleDeleteDocument = async () => {
    ...
    try {
      ...
      setDeleteSuccess(`Đã xóa tài liệu "${documentToDelete.title}" thành công!`);
          ...
          <main className={`p-4 md:p-6 ${isDarkMode ? 'bg-gray-900 text-white' : 'bg-slate-100 text-gray-900'}`}>
            <div className="max-w-7xl mx-auto">
              <div className="flex flex-col md:flex-row md:items-center justify-between mb-6">
                <h1 className="text-2xl font-bold mb-4 md:mb-0">Quản lý Tài Liệu</h1>
            ...
            <div className="mb-8">
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                ...
                <div className="flex flex-col md:flex-row gap-2 md:items-center">
                  {/* Category Filter */}
                  <div className={`relative rounded-lg overflow-hidden ${isDarkMode ? 'bg-gray-800' : 'bg-white'} shadow-sm w-full md:w-64`}>
                    <select
                  ...
                  {/* Search Box */}
                  <div className={`relative rounded-lg overflow-hidden ${isDarkMode ? 'bg-gray-800' : 'bg-white'} shadow-sm w-full md:w-96 lg:w-[500px]`}>
                    <input
                      type="text"
              ...
              <div className={`${isDarkMode ? 'bg-gray-800 border border-gray-700' : 'bg-white'}`}>
                <div className={`px-6 py-4 ${isDarkMode ? 'bg-gray-700/50 border-b border-gray-700' : 'bg-gray-50 border-b border-gray-200'}`}>
                  ...
                  <p className={`mt-1 text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`}>
                    {loading ? 'Đang tải...' : `Hiển thị ${filteredDocuments.length} / ${documents.length} tài liệu trong hệ thống`}
                  </p>
                </div>
                            ...
                            <div className="flex space-x-3 items-center">
                              ...
                              <div className="flex flex-col items-center space-y-1">
                                ...
                                <div className={`w-8 h-8 flex items-center justify-center rounded-md ${isDarkMode ? 'bg-gray-600' : 'bg-blue-100'}`}>
                                  <svg className={`h-5 w-5 ${isDarkMode ? 'text-blue-300' : 'text-blue-600'}`} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div className="hidden md:block w-full overflow-x-auto" style={{ WebkitOverflowScrolling: 'touch' }}>
                      <table className={`min-w-full divide-y ${isDarkMode ? 'divide-gray-700' : 'divide-gray-200'}`}>
                        ...
                        <tbody className={`divide-y ${isDarkMode ? 'divide-gray-700' : 'divide-gray-200'}`}>
                          {filteredDocuments.map((doc, index) => (
                            <tr key={doc.id} className={isDarkMode ? 'hover:bg-gray-700/30' : 'hover:bg-gray-50'}>
              ...
              <div className={`px-6 py-5 ${isDarkMode ? 'bg-gray-700 text-gray-200' : 'bg-gray-50 text-gray-800'}`}>
                {deleteSuccess ? (
                  ...
                  <form>
                    ...
                    {/* Warning message */}
                    <div className={`p-3 mb-5 text-sm rounded-md border ${
                      isDarkMode 
                    ...
                    <div className="flex items-center mb-5">
                      ...
                      >
                        Tôi xác nhận muốn xóa tài liệu này và tất cả câu hỏi liên quan
                      </label>
                    </div>
