...
const UserAddForm = ({ isOpen, onClose, onSubmit, formData, formErrors, loading, onChange }) => {
  ...
  const inputClasses = "w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500";  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-80">
      <div 
        ref={formRef}
        className="bg-white text-gray-800 rounded-lg shadow-xl p-6 w-[95%] mx-auto border-2 border-gray-300 md:w-[80%]"
          ...
          <div className="md:flex md:space-x-4 md:space-y-0 space-y-4">
            ...
            <div className="md:w-1/2">
              ...
              <input
                ...
                onChange={onChange}
                className={`${inputClasses} ${formErrors.fullName ? 'border-red-500' : ''}`}
          ...
          <div className="md:flex md:space-x-4 md:space-y-0 space-y-4">
            ...
            <div className="md:w-1/2">
              ...
              <input
                ...
                onChange={onChange}
                className={`${inputClasses} ${formErrors.phone ? 'border-red-500' : ''}`}
          ...
          <div className="md:flex md:space-x-4 md:space-y-0 space-y-4">
            ...
            <div className="md:w-1/2">
              ...
              <input
                ...
                onChange={onChange}
                className={`${inputClasses} ${formErrors.confirmPassword ? 'border-red-500' : ''}`}
