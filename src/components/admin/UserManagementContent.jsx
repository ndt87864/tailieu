  ...
  return (
    <div className={`flex flex-col min-h-screen ${isDarkMode ? 'bg-gray-900' : 'bg-slate-100'}`}>
      ...
      <div className="flex min-h-screen relative">
        ...
        <div className={`flex flex-col flex-1 ${isDarkMode ? 'bg-gray-900' : 'bg-slate-50'}`}>
                  ...
                  <nav className="text-sm mb-2">
                    <ol className="list-none p-0 inline-flex">
                      <li className="flex items-center">
                        <span className={isDarkMode ? 'text-gray-400' : 'text-gray-500'}>Quản trị</span>
                        <svg className="h-4 w-4 mx-2 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                          <path fillRule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clipRule="evenodd" />
                        </svg>
                      </li>
                      <li>
                        <span className={`font-medium ${isDarkMode ? 'text-white' : 'text-gray-800'}`}>Quản lý người dùng</span>
                      </li>
                    </ol>
                  </nav>
                  <h1 className={`text-2xl font-bold ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>Quản lý người dùng</h1>
                ...
                <table className={`min-w-full divide-y ${isDarkMode ? 'divide-gray-700' : 'divide-gray-200'}`}>
                  ...
                  <tbody className={`divide-y ${isDarkMode ? 'divide-gray-700' : 'divide-gray-200'}`}>
                    {users.length > 0 ? (
                      ...
                      <tr>
                        <td colSpan="5" className={`px-6 py-10 text-center ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`}>
                          ...
                          <span className="block font-medium text-sm mb-1">Không có dữ liệu người dùng</span>
                          <span className="text-xs">Chưa có người dùng nào trong hệ thống</span>
                        </td>
                      </tr>
                    )}
                  </tbody>
                    ...
                    <div className={`p-3 mb-5 text-sm rounded-md border ${
                      ...
                      <div className="flex items-center">
                        <svg className="h-5 w-5 mr-2 text-red-400 flex-shrink-0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                          <path fillRule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v3a1 1 0 102 0V6a1 1 0 00-1-1z" clipRule="evenodd" />
                        </svg>
                        <span className="font-medium">Cảnh báo: </span>
                        <span className="ml-1">
                          Thao tác này sẽ xóa vĩnh viễn tài khoản người dùng khỏi hệ thống!
                        </span>
                      </div>
                    </div>
