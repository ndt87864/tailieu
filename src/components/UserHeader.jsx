...
const UserHeader = ({ title }) => {
  ...
  return (
    <header className={`${isDarkMode ? 'bg-gray-900 border-gray-700 text-white' : 'bg-slate-50 border-gray-200 text-gray-900'} px-6 py-3 flex items-center justify-between border-b sticky top-0 z-10 shadow-md border-l-0`}>
      <div className="flex items-center">
        <h1 className={`text-xl font-bold ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>{title || 'Tài liệu HOU'}</h1>
      </div>
